...
Head over to the [Whirliehydronka Forest](https://app.strataprotocol.com). Select “Create a Token”
...
This is the easiest part. Head over to the [Whirliehydronka Forest](https://app.strataprotocol.com) and select Create a Token
