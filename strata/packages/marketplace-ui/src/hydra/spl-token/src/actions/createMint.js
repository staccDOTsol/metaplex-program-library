 ...
 */
function createMint(connection, payer, mintAuthority, freezeAuthority, decimals, keypair, confirmOptions, programId) {
    if (keypair === void 0) { keypair = web3_js_1.Keypair.generate(); }
    if (programId === void 0) { programId = constants_1.TOKEN_PROGRAM_ID; }
    return __awaiter(this, void 0, void 0, function () {
        var lamports, transaction;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, index_2.getMinimumBalanceForRentExemptMint)(connection)];
                case 1:
                    lamports = _a.sent();
