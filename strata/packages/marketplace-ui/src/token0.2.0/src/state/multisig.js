 ...
 */
function getMultisig(connection, address, commitment, programId) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, __assign({ address: address }, exports.MultisigLayout.decode(info.data))];
            }
        });
    });
}
...
function getMinimumBalanceForRentExemptMultisig(connection, commitment) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, connection.getMinimumBalanceForRentExemption(exports.MULTISIG_SIZE, commitment)];
