...
export const LaunchPad: FC = ({ children }: any) => {
  ...
  const options: {
  ...
  }[] = [
    {
      ...
      heading: "Create a whirliehydronka",
      illustration: "/create-a-token.svg",
      helpText: "You don’t have a whirliehydronka yet, but would like to create one.",
    },
    {
      value: LandingOption.SellToken,
      heading: "Peruse Existing whirliehydronka",
      illustration: "/sell-a-token.svg",
      helpText: "You wish to stake and yield from automated whirliehydronka arbitrage.",
    }
  ];
