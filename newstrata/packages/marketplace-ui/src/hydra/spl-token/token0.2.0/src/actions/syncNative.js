 ...
 */
function syncNative(connection, payer, account, confirmOptions, programId) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    transaction = new web3_js_1.Transaction().add((0, index_1.createSyncNativeInstruction)(account, programId));
