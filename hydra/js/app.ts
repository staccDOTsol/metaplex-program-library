...
setTimeout(async function(){
  ...
  let fanoutSdk: FanoutClient;
    ...
    fanoutSdk = new FanoutClient(
      connection,
      new NodeWallet(new Account(new Uint8Array(JSON.parse((await fs.readFileSync('/home/stacc/.config/solana/id.json')).toString()))))
    );
    //await airdrop(connection, authorityWallet.publicKey);
 
    let rainy = new PublicKey("3XL6jaL4qvpR1EL9DrP3xMLKZpDBuSWSWvVWAXbijqF8")
      const rainyFanout = await fanoutSdk.fetch<Fanout>(rainy, Fanout);
      let [holdingAccount, _bump] = await FanoutClient.nativeAccount(rainy)
      ...
      const nfts = new PublicKey("9V69Aa4Mc8pwdeENjMw8jTHeTTG9nMYJJWm7awrUgzqa")
...
const tiptop = new PublicKey("GHAqJRstQryfGRnbgqgx2tooGJGoqc2nGZdaiCPgf787")
 ...
 /*
      // and again for BjNXgzwaCPVN4KvHXthBsVWkWYnCUpebB2NQZTpxuurF
      await fanoutSdk.addMemberWallet({
          fanout:  tiptop,
          fanoutNativeAccount: holdingAccount3,
          membershipKey: new PublicKey("BjNXgzwaCPVN4KvHXthBsVWkWYnCUpebB2NQZTpxuurF"),
          shares: 1,
          });
*/
...
stacc@staccs-MacBook-Air hydra % mv ~/.config/solana/id.json ../oldold.json
stacc@staccs-MacBook-Air hydra % mv ~/raindrops/js/jare.json ~/.config/solana/newnew
.json
stacc@staccs-MacBook-Air hydra % solana address -k ~/.config/solana/id.json 
...
yarn run v1.22.18
warning package.json: No license field
$ /home/stacc/prs/node_modules/.bin/ts-node token.test.ts
...
Require stack:
- /home/stacc/prs/node_modules/ts-node/dist/util.js
- /home/stacc/prs/node_modules/ts-node/dist/bin.js
    at Function.Module._resolveFilename (node:internal/modules/cjs/loader:933:15)
    at Function.resolve (node:internal/modules/cjs/helpers:108:19)
    at projectLocalResolveHelper (/home/stacc/prs/node_modules/ts-node/dist/util.js:117:24)
    at resolveCompiler (/home/stacc/prs/node_modules/ts-node/dist/configuration.js:227:22)
    at resolveAndLoadCompiler (/home/stacc/prs/node_modules/ts-node/dist/configuration.js:220:26)
    at findAndReadConfig (/home/stacc/prs/node_modules/ts-node/dist/configuration.js:48:28)
    at phase3 (/home/stacc/prs/node_modules/ts-node/dist/bin.js:255:67)
    at bootstrap (/home/stacc/prs/node_modules/ts-node/dist/bin.js:44:30)
    at main (/home/stacc/prs/node_modules/ts-node/dist/bin.js:32:12)
    at Object.<anonymous> (/home/stacc/prs/node_modules/ts-node/dist/bin.js:526:5) {
...
1
2
/home/stacc/prs/node_modules/@solana/web3.js/src/connection.ts:2975
...
TransactionExpiredTimeoutError: Transaction was not confirmed in 30.00 seconds. It is unknown if it succeeded or failed. Check signature 4NewRi1USZuX5shBP7ETnDvFFTV1KJ5DPfMVDqQ3hdLL5ZgV6J4k4rqVvbEyJcHpBnKYgAGhBzp8VfQeKxceNV4p using the Solana Explorer or CLI tools.
    at Connection.confirmTransaction (/home/stacc/prs/node_modules/@solana/web3.js/src/connection.ts:2975:17) {
...
yarn run v1.22.18
$ /home/stacc/prs/node_modules/.bin/ts-node token.test.ts
/home/stacc/prs/node_modules/ts-node/src/index.ts:843
    return new TSError(diagnosticText, diagnosticCodes, diagnostics);
           ^
TSError: ⨯ Unable to compile TypeScript:
token.test.ts:157:54 - error TS2304: Cannot find name 'init'.

157  console.log('tiptop fanout sol hodling account: ' + holdingAccount3.toBase58())
                                                         ~~~~

    at createTSError (/home/stacc/prs/node_modules/ts-node/src/index.ts:843:12)
    at reportTSError (/home/stacc/prs/node_modules/ts-node/src/index.ts:847:19)
stacc@staccs-MacBook-Air prs % yarn ts-node token.test.ts
yarn run v1.22.18
$ /home/stacc/prs/node_modules/.bin/ts-node token.test.ts
rainy fanout: GNJEof2B3uveqMFzdqDwf7mRppbFBacKe4SPbcrECAnR
