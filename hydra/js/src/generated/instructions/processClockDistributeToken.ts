 ...
 * @category ProcessClockDistributeToken
 * @category generated
 */
export type ProcessClockDistributeTokenInstructionArgs = {
 ...
 * @category generated
 */
export const processClockDistributeTokenStruct = new beet.BeetArgsStruct<
  ProcessClockDistributeTokenInstructionArgs & {
...
/**
 * Accounts required by the _processClockDistributeToken_ instruction
 *
 ...
 * @category generated
 */
export type ProcessClockDistributeTokenInstructionAccounts = {
...
export const processClockDistributeTokenInstructionDiscriminator = [
  104, 155, 128, 81, 147, 182, 60, 102,
];

/**
 * Creates a _ProcessClockDistributeToken_ instruction.
 *
 ...
 * @category generated
 */
export function createProcessClockDistributeTokenInstruction(
  accounts: ProcessClockDistributeTokenInstructionAccounts,
  args: ProcessClockDistributeTokenInstructionArgs,
  programId = new web3.PublicKey('hyDQ4Nz1eYyegS6JfenyKwKzYxRsCWCriYSAjtzP4Vg'),
) {
  const [data] = processClockDistributeTokenStruct.serialize({
    instructionDiscriminator: processClockDistributeTokenInstructionDiscriminator,
    ...args,
  });
