 ...
 */
export async function getMint(connection, address, commitment, programId = TOKEN_2022_PROGRAM_ID) {
 ...
 */
export function unpackMint(address, info, programId = TOKEN_2022_PROGRAM_ID) {
    if (!info)
 ...
 */
export async function getAssociatedTokenAddress(mint, owner, allowOwnerOffCurve = false, programId = TOKEN_2022_PROGRAM_ID, associatedTokenProgramId = ASSOCIATED_TOKEN_PROGRAM_ID) {
 ...
 */
export function getAssociatedTokenAddressSync(mint, owner, allowOwnerOffCurve = false, programId = TOKEN_2022_PROGRAM_ID, associatedTokenProgramId = ASSOCIATED_TOKEN_PROGRAM_ID) {
    if (!allowOwnerOffCurve && !PublicKey.isOnCurve(owner.toBuffer()))
        throw new TokenOwnerOffCurveError();
