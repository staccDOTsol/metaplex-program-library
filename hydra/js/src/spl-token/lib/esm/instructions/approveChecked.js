 ...
 */
export function createApproveCheckedInstruction(account, mint, delegate, owner, amount, decimals, multiSigners = [], programId = TOKEN_2022_PROGRAM_ID) {
 ...
 */
export function decodeApproveCheckedInstruction(instruction, programId = TOKEN_2022_PROGRAM_ID) {
