 ...
 */
export function createUiAmountToAmountInstruction(mint, amount, programId = TOKEN_2022_PROGRAM_ID) {
 ...
 */
export function decodeUiAmountToAmountInstruction(instruction, programId = TOKEN_2022_PROGRAM_ID) {
