 ...
 */
export function createAmountToUiAmountInstruction(mint, amount, programId = TOKEN_2022_PROGRAM_ID) {
 ...
 */
export function decodeAmountToUiAmountInstruction(instruction, programId = TOKEN_2022_PROGRAM_ID) {
