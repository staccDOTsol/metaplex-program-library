 ...
 */
export function createInitializeAccount3Instruction(account, mint, owner, programId = TOKEN_2022_PROGRAM_ID) {
    const keys = [
 ...
 */
export function decodeInitializeAccount3Instruction(instruction, programId = TOKEN_2022_PROGRAM_ID) {
