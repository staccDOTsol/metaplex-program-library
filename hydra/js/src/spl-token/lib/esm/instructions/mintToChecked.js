 ...
 */
export function createMintToCheckedInstruction(mint, destination, authority, amount, decimals, multiSigners = [], programId = TOKEN_2022_PROGRAM_ID) {
 ...
 */
export function decodeMintToCheckedInstruction(instruction, programId = TOKEN_2022_PROGRAM_ID) {
