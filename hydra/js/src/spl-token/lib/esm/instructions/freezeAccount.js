 ...
 */
export function createFreezeAccountInstruction(account, mint, authority, multiSigners = [], programId = TOKEN_2022_PROGRAM_ID) {
 ...
 */
export function decodeFreezeAccountInstruction(instruction, programId = TOKEN_2022_PROGRAM_ID) {
