 ...
 */
export function createInitializeAccountInstruction(account, mint, owner, programId = TOKEN_2022_PROGRAM_ID) {
    const keys = [
 ...
 */
export function decodeInitializeAccountInstruction(instruction, programId = TOKEN_2022_PROGRAM_ID) {
