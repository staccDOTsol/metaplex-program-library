 ...
 */
export function createBurnCheckedInstruction(account, mint, owner, amount, decimals, multiSigners = [], programId = TOKEN_2022_PROGRAM_ID) {
 ...
 */
export function decodeBurnCheckedInstruction(instruction, programId = TOKEN_2022_PROGRAM_ID) {
