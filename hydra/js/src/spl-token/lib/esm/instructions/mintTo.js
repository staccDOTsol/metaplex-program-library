 ...
 */
export function createMintToInstruction(mint, destination, authority, amount, multiSigners = [], programId = TOKEN_2022_PROGRAM_ID) {
 ...
 */
export function decodeMintToInstruction(instruction, programId = TOKEN_2022_PROGRAM_ID) {
